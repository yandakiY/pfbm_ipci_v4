  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" style="border:solid 4px black;font-family: consolas">Création nouveau type utilisateur</h1>
      </div>
      
      
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Renseignez les informations</h4>
        <form action="registrationTypeUser" method="post">
          <div class="row">
          
            <div class="col-md-8">
              <label for="nom_type_user" class="form-label">Nom utilisateur :</label>
              <input type="text" class="form-control" id="nom_type_user" name="nom_type_user" required>
            </div>
            
            <div class="col-md-8">
              <label for="description_type_user" class="form-label">Description (Optionnel) :</label>
              <textarea rows="" cols="" class="form-control" id="description_type_user" name="description_type_user"></textarea>
            </div>
