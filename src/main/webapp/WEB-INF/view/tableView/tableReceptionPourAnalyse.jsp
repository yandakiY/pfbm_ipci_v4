  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" style="border:solid 4px black;font-family: consolas">Effectuer des analyses</h1>
				...
				-->
		      		...
		      		<c:choose>
		      			<c:when test="${type_user eq 'TU-2022-1' }">
		      				<a class="text-infos" href="gestionInterpretations">Gérer les interpretations des resultats</a>
		      			</c:when>
		      			<c:otherwise>
		      				<a style="display:none;" class="text-infos" href="gestionInterpretations">Gérer les interpretations des resultats</a>
		      			</c:otherwise>
		      		</c:choose>
		      		<!-- <a class="text-infos" href="gestionInterpretations">Gérer les interpretations des resultats</a>  -->
	      		 </div>
		          ...
		          <tr>
		            ...
		            <th scope="col">Nombre des échantillons</th>
		          ...
		          <c:forEach items="${listReceptions }" var="reception">
		          	 <tr>
			            ...
			            <td>${reception.getNb_prelevement() }</td>
			            <td>${reception.getDate_reception() }</td>
			            <td>
			            	<a type="button" href="tableechantillonparreceptionmakeanalyse?id_reception=${reception.getId_reception()}" class="btn-sm btn-secondary">Analyser les echantillons de ${reception.getId_reception() }</a>
			            </td>
			          </tr>
		          </c:forEach>
