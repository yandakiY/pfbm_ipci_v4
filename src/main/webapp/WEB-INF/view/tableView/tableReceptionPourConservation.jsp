  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" style="border:solid 4px black;font-family: consolas">Listes des receptions (Pour faire la conservation)</h1>
      		...
      		<!-- CHAMP TABLE DES ECHANTILLONS -->
		        ...
		        <table class="table table-hover table-striped text-center table-bordered">
		          ...
		          <tr>
		            ...
		            <th style="display:none;" scope="col">Nombre des échantillons</th>
		          ...
		          <c:forEach items="${listReceptions }" var="reception">
		          	 <tr>
			            ...
			            <td>
			            	<a type="button" href="tableechantillonparreceptionpourconservation?id_reception=${reception.getId_reception()}" class="btn-sm btn-secondary">Liste des echantillons de ${reception.getId_reception() } a conserver</a>
			            </td>
			          </tr>
		          </c:forEach>
