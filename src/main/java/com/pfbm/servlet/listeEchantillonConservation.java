...
/**
 * Servlet implementation class listeEchantillonConservation
 */
@WebServlet("/listeEchantillonConservation")
public class listeEchantillonConservation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public listeEchantillonConservation() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("listEchantillons", echantillonDao.getAllEchantillonsWhereConservation());
		request.setAttribute("listEchantillons1", echantillonDao.getAllEchantillonsWhereNotConservation());
		...
		if(login_user == null && nom_user == null && prenom_user == null) {
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/listeEchantillonsConservation.jsp").forward(request, response);
		}
		//this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/listeEchantillonsConservation.jsp").forward(request, response);
	}
