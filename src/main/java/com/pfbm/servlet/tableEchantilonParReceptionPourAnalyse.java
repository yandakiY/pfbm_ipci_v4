...
/**
 * Servlet implementation class tableEchantilonParReceptionPourAnalyse
 */
@WebServlet("/tableechantillonparreceptionmakeanalyse")
public class tableEchantilonParReceptionPourAnalyse extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public tableEchantilonParReceptionPourAnalyse() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("listEchantillons", echantillonDao.getEchantillonsByIdReception(id_reception));
		...
		if(login_user == null && nom_user == null && prenom_user == null) {
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/tableEchantilonParReceptionPourAnalyse.jsp").forward(request, response);
		}
