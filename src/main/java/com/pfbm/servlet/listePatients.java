...
/**
 * Servlet implementation class listePatients
 */
...
public class listePatients extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(login_user == null && nom_user == null && prenom_user == null) {
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/listepatients.jsp").forward(request, response);
		}
