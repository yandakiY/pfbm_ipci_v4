...
/**
 * Servlet implementation class tableReceptionPourConservation
 */
@WebServlet("/makeemplacement")
public class tableReceptionPourConservation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public tableReceptionPourConservation() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(login_user == null && nom_user == null && prenom_user == null) {
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/tableReceptionPourConservation.jsp").forward(request, response);
		}
