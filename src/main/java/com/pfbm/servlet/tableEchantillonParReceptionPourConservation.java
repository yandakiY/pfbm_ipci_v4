...
/**
 * Servlet implementation class tableEchantillonParReceptionPourConservation
 */
@WebServlet("/tableechantillonparreceptionpourconservation")
public class tableEchantillonParReceptionPourConservation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public tableEchantillonParReceptionPourConservation() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("reception", receptionDao.getReceptionByIdReception(id_reception));
		...
		request.setAttribute("listEchantillons", echantillonDao.getEchantillonsWhereConservation(id_reception));
		*/
		...
		if(login_user == null && nom_user == null && prenom_user == null) {
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/tableEchantillonParReceptionPourConservation.jsp").forward(request, response);
		}
//		this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/tableEchantillonParReceptionPourConservation.jsp").forward(request, response);
	}
