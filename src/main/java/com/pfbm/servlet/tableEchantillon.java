 ...
 */
@WebServlet("/tableechantillon")
public class tableEchantillon extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public tableEchantillon() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(login_user == null && nom_user == null && prenom_user == null) {
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/tableEchantillon.jsp").forward(request, response);
		}
		//this.getServletContext().getRequestDispatcher("/WEB-INF/view/tableView/tableEchantillon.jsp").forward(request, response);
	}
